...
})({"aCQrd":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "33186f926b0d4553";
"use strict";
    ...
    toggleCamera() {
        if (this.localStream) {
            ...
            if (videoTrack) {
                ...
                this.cameraIcon.className = this.cameraOpen ? "fa-solid fa-video" : "fa-solid fa-video-slash";
            }
    ...
    toggleMic() {
        if (this.localStream) {
            ...
            if (audioTrack) {
                ...
                this.micIcon.className = this.micOpen ? "fa-solid fa-microphone" : "fa-solid fa-microphone-slash";
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["aCQrd","djbTg"], "djbTg", "parcelRequirebeba", {})

//# sourceMappingURL=dummy.6b0d4553.js.map
